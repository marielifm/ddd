...
import SendConsoleLog3Handler from '../../customer/event/handler/send-console-log3.handler';
import SendEmailWhenProductIsCreatedHandler from '../../product/events/handler/send-email-when-productIs-created.handler';
